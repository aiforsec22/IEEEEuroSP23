...
if __name__ == '__main__':
    ...
    parser.add_argument("--tail_entity", type=str, default=None, nargs="?",
                    help="tail entity used for prediction")
    ...
    d = Data(data_dir=data_dir, reverse=False, tail_entity=args.tail_entity)
